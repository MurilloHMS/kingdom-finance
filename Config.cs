...
namespace CKFinance
{
    public partial class Config : Form
    {
        ...
        private void btnCTable_Click(object sender, EventArgs e)
        {
            ...
            string users = "CREATE TABLE Users (ID INT IDENTITY(1,1) PRIMARY KEY, NOME VARCHAR(128), USUARIO VARCHAR(15), CARGO VARCHAR(30), SENHA VARCHAR(20), DATACADASTRO DATE)";
            string finance = "CREATE TABLE Financeiro (ID INT IDENTITY(1,1) PRIMARY KEY, VALOR DECIMAL(8,2), CULTO VARCHAR(20), DATAENTRADA DATE, DATAALTERACAO DATE, USUARIOENTRADA VARCHAR(15), USUARIOALTERACAO VARCHAR(15),DESCRICAO TEXT)";
